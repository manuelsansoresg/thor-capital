                ...
                <table id="dataTable" class="table table-bordered table-responsive">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td> {{ Str::limit(strip_tags($es_section['person_name1'] ) , 40) }}</td>
                            <td>{{ Str::limit(strip_tags($es_section['person_name2'] ) , 40) }}</td>
                            <td>
                            ...
                            <td>
                                ...
                                <a href="/#the-team" target="_blank" class="btn btn-success btn-sm"><i class="far fa-eye"></i> </a>

                                <a href="{{route('team.edit', $es_section['lang'])}}" class="btn btn-primary btn-sm">
