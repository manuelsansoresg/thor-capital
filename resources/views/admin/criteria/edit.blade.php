...
<div class="content">
    <div class="row">
        <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                {{ Form::open(['route' => ['criteria.update', $section_id], 'method' => 'PUT', 'files' => true]) }}
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            @if($image != '')
                                <img src="{{ asset('img/criteria').'/'.'thumb_'.$image->image }}" alt="">
                                <div class="pull-right">
                                    <p>
                                        <br>
                                        <a href="/admin/criteria/image/destroy/{{ $image->id }}/{{ $set_lang }}" class="btn btn-danger ">Borrar</a>
                                    </p>
                                </div>
                            @endif
                        </div>
                        ...
                        <div class="col-md-2">
                            @if($image_thumb != '')
                                <img src="{{ asset('img/criteria').'/'.'thumb_'.$image_thumb->image }}" alt="">
                                <div class="pull-right">
                                    <p>
                                        <br>
                                        <a href="/admin/criteria/image/destroy/{{ $image_thumb->id }}/{{ $set_lang }}" class="btn btn-danger ">Borrar</a>
                                    </p>
                                </div>
                            @endif
                        </div>
