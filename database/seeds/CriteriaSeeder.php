...
class CriteriaSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $section_language->description = '
            Nuestra experiencia como dueños, directores y empresarios nos permite tener una visión totalmente diferente para determinar cómo realizamos nuestras inversiones.   
        <p class="mt-3 ml-0">
           Los criterios de inversiones de TOR Capital no son inamovibles, pues entendemos que cada empresa es única, con su propia historia y que requiere un análisis profundo más allá de los números.
         ...
         El centro de nuestras inversiones se ubica en las empresas:
            ...
            <ul class="ml-0">
                <li>
                De por lo menos tres años de operaciones.

                </li>
                <li>
               Con ingresos anuales de entre cinco y cincuenta millones de pesos.
                </li>
                <li>
                Con EBITDA de por lo menos un millón de pesos.

                </li>
                <li>
                 Compuestas por un equipo de dirección experimendo.
        ...
        $section_language->description = '
                                           ...
                                           Capital de expansión.
                                            ...
                                            <li>         Liquidez de accionista. </li>
                                            <li>      Recapitalización. </li>
                                            <li>     Adquisición por la dirección.    </li>
                                           </ul>
                                          ';
        $section_language->save();
       ...
       /* seccion1 español*/
        ...
        $section_language->description = '
                                           <ul>
                                           <li>Types de transaction. </li>
                                           <li>Capital d\'expansion. </li>
                                           <li>Financement d\'acquisition. </li>
                                           <li>Liquidité d\'actionnaire. </li>
                                           <li>Recapitalisation. </li>
                                           <li>Acquisition par la direction. </li>
                                           </ul>
                                          ';
        $section_language->save();
