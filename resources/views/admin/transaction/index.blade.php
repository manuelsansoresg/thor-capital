                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="/admin/transaction-list/{{ $es_section['lang'] }}"  class="btn btn-info btn-sm"> <i class="fas fa-list"></i> </a>

                                <a href="{{route('transaction.edit', $es_section['lang'])}}" class="btn btn-primary btn-sm">
